...
deploy {
    application {
        ...
        homepage = 'http://localhost/RobotEdit'
        description {
            complete = 'RobotEdit 0.1'
            oneline  = 'RobotEdit 0.1'
            minimal  = 'RobotEdit 0.1'
            tooltip  = 'RobotEdit 0.1'
        }
        icon {
            fallback {
...
app.fileType = '.groovy'
app.defaultPackageName = 'robotedit'
